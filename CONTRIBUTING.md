...
维护者以 v0.2.0 的 475 篇为基线，每累计新增 25 篇经授权、通过审计且可公开的文章，常规更新
一次 GitHub 仓库与数据集 Release；下一常规批次目标为 500 篇。每批应同步正文、元数据、索引、
许可、QA、站点、引用信息、变更记录和 Release 数据包。

该节奏不限制社区随时提交纠错，也不延迟安全、隐私、撤稿或权利问题的处理。未来文章仍须逐篇
完成来源、授权和公开边界审查，达到数量阈值不等于自动纳入全文数据集。
