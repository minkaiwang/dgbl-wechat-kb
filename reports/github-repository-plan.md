...
- 发布状态：v0.1.1 的“代码 + 475 条安全元数据”已公开并完成匿名下载复核。
...
2. v0.1.1 范围固定为代码、测试、审计材料和 475 条公开安全元数据。
3. 代码采用 MIT；公开元数据和项目文档采用 CC BY 4.0。
4. 正文、摘要片段与图片继续排除，文章正文许可仍待逐项确认。
5. 用户已明确授权公开仓库及 v0.1.1 元数据 Release；发布与发布后复核均已完成。

v0.1.1 GitHub Release 新增编号 483，总数为 475 条，发布对象限定为公众号帖子公开元数据集。
